...
const Footer = () => {
  return (
    <div className='flex bg-[#2cb52c] items-center h-16 gap-2 md:gap-24 max-w-screen justify-center'>
          <div className='flex gap-2 md:gap-8 items-center justify-start pr-4 pl-4 bg-[#3aac3a] p-1 rounded-3xl drop-shadow-lg h-12 w-1/2 md:w-1/6'>
          ...
          <div className='flex gap-2 md:gap-8 items-center pl-4 pr-4 bg-[#3aac3a] p-1 rounded-3xl drop-shadow-lg h-12 w-1/2 md:w-1/6 justify-between'>
