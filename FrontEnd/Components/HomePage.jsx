      ...
      <div className='main'>
       ...
       <div className='flex justify-center pb-2 md:pt-8 lg:pt-10'> {/* HEAD INTRO*/}
        <div className='title flex pt-4 flex-col justify-center w-10/12 md:w-5/12 lg:w-3/12 text-center gap-2'>
          <h1 className='text-5xl justify-center flex bg-[#247224] border drop-shadow-xl p-2 rounded-full font-Abril'>SED PEPE</h1>
          ...
          <p className=' text-4xl justify-center flex pt-80 font-Monoton md:text-5xl lg:text-[3rem]'> The King Of All Memes is SED!!</p>
        </div>
        </div>
        
        <div className='flex p-6 w-full justify-center'>

          <div className=' text-justify bg-[#247224] border drop-shadow-lg w-11/12 md:w-8/12 lg:w-5/12 flex justify-center flex-col items-center pt-4 pb-4 pl-2 pr-2'>
          
            <h1 className='text-2xl pb-4 font-titleFont'>ABOUT SED PEPE</h1>
          ...
          <p className='pt-1 text-justify text-2xl font-titleFont'>Pepe Is Looks forward for Your Support!!</p>
