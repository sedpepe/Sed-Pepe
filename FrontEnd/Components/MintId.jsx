...
const Mint = () => {
  return (
    <div className='flex flex-col justify-center h-screen w-screen items-center bg-[#2b892b]'>
      ...
      <div className='relative z-10 items-center text-center flex flex-col justify-center gap-8 cursor-pointer'>
        <Image src={'/sorry.gif'} height={800} width={800}/>
        <div className=' text-white font-a rounded-full p-5 shadow-xl bg-[#2b892b] gap-4 flex flex-col w-[80rem] h-[9rem] hover:text-yellow-300'>
